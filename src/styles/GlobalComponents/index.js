...
export const ButtonBack = styled.div`
  ...
  margin: ${({ alter, form }) => (alter || form ? "0" : "0 0 80px")};
  color: #fff;
  background: ${({ alter }) =>
    alter
  ...
  @media ${(props) => props.theme.breakpoints.md} {
    width: ${({ alter }) => (alter ? "150px" : "184px")};
    height: ${({ alter }) => (alter ? "52px" : "48px")};
    font-size: ${({ alter }) => (alter ? "20px" : "16px")};
    margin-bottom: ${({ alter }) => (alter ? "0" : "64px")};
  }
  ...
  @media ${(props) => props.theme.breakpoints.sm} {
    ...
    height: 32px;
    font-size: 14px;
    margin-bottom: ${({ alter }) => (alter ? "0" : "32px")};
  }
`;
